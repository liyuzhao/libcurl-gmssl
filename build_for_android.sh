...
$BASE_PATH/jni/compile-gmssl.sh
checkExitCode $?
...
compile() {
	...
	safeMakeDir $BASE_PATH/obj/$ABI/gmssl
	cd $BASE_PATH/obj/$ABI/gmssl
	$AR -x $BUILD_PATH/gmssl/$ABI/lib/libssl.a
	$AR -x $BUILD_PATH/gmssl/$ABI/lib/libcrypto.a
	checkExitCode $?
	...
	cd $BASE_PATH
	$AR -cr $BASE_PATH/libs/$ABI/libcurl.a $BASE_PATH/obj/$ABI/curl/*.o $BASE_PATH/obj/$ABI/gmssl/*.o $BASE_PATH/obj/$ABI/zlib/*.o
	checkExitCode $?
	# copy dylib
